...
+ (NSMutableAttributedString *)configureAttributedString:(NSAttributedString *)attrStr
                                       ...
                                       verticalAlignment:(IDULabelVerticalAlignment)verticalAlignment
                                              attributes:(NSDictionary *)attributes
{
    return [IDULabelUtilities configureLinkAttributedString:attrStr addImageName:imageName imageSize:size atIndex:loc verticalAlignment:verticalAlignment linkAttributes:attributes activeLinkAttributes:nil parameter:nil clickLinkBlock:nil longPressBlock:nil islink:NO];
}
...
+ (NSMutableAttributedString *)configureLinkAttributedString:(NSAttributedString *)attrStr
                                        ...
                                        activeLinkAttributes:(NSDictionary *)activeLinkAttributes
                                              ...
                                              longPressBlock:(IDULabelLinkModelBlock)longPressBlock
{
    return [IDULabelUtilities configureLinkAttributedString:attrStr addImageName:imageName imageSize:size atIndex:loc verticalAlignment:verticalAlignment linkAttributes:linkAttributes activeLinkAttributes:activeLinkAttributes parameter:parameter clickLinkBlock:clickLinkBlock longPressBlock:longPressBlock islink:YES];
}
...
+ (NSMutableAttributedString *)configureAttributedString:(NSAttributedString *)attrStr
                                              ...
                                              attributes:(NSDictionary *)attributes
{
    return [IDULabelUtilities configureLinkAttributedString:attrStr atRange:range linkAttributes:attributes activeLinkAttributes:nil parameter:nil clickLinkBlock:nil longPressBlock:nil islink:NO];
}
...
+ (NSMutableAttributedString *)configureLinkAttributedString:(NSAttributedString *)attrStr
                                        ...
                                        activeLinkAttributes:(NSDictionary *)activeLinkAttributes
                                              ...
                                              longPressBlock:(IDULabelLinkModelBlock)longPressBlock
{
    return [IDULabelUtilities configureLinkAttributedString:attrStr atRange:range linkAttributes:linkAttributes activeLinkAttributes:activeLinkAttributes parameter:parameter clickLinkBlock:clickLinkBlock longPressBlock:longPressBlock islink:YES];
}
...
+ (NSMutableAttributedString *)configureAttributedString:(NSAttributedString *)attrStr
                                        ...
                                        sameStringEnable:(BOOL)sameStringEnable
                                              attributes:(NSDictionary *)attributes
{
    return [IDULabelUtilities configureLinkAttributedString:attrStr withString:withString sameStringEnable:sameStringEnable linkAttributes:attributes activeLinkAttributes:nil parameter:nil clickLinkBlock:nil longPressBlock:nil islink:NO];
}
...
+ (NSMutableAttributedString *)configureLinkAttributedString:(NSAttributedString *)attrStr
                                        ...
                                        activeLinkAttributes:(NSDictionary *)activeLinkAttributes
                                              ...
                                              longPressBlock:(IDULabelLinkModelBlock)longPressBlock
{
    return [IDULabelUtilities configureLinkAttributedString:attrStr withString:withString sameStringEnable:sameStringEnable linkAttributes:linkAttributes activeLinkAttributes:activeLinkAttributes parameter:parameter clickLinkBlock:clickLinkBlock longPressBlock:longPressBlock islink:YES];
}
...
- (CGFloat)yOffset:(CGFloat)y lineVerticalLayout:(IDUCTLineVerticalLayout)lineVerticalLayout lineDescent:(CGFloat)lineDescent isImage:(BOOL)isImage imageHight:(CGFloat)imageHight imageVerticalAlignment:(IDULabelVerticalAlignment)imageVerticalAlignment {
    ...
    IDULabelVerticalAlignment verticalAlignment = lineVerticalLayout.verticalAlignment;
    if (isImage) {
            ...
            if (isLink) {
                IDUGlyphRunStrokeItem *runStrokeItem = [self runStrokeItemFromGlyphRun:glyphRun
                                                                   ...
                                                                   lineVerticalLayout:lineVerticalLayout
                                                                              isImage:!IDULabelIsNull(imgInfoDic)
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    if (_longPress) {
        ...
        if (_currentClickRunStrokeItem) {
            ...
            IDULabelLinkModel *linkModel =
            [[IDULabelLinkModel alloc]initWithAttributedString:attributedString
...
@implementation IDULabelLinkModel
